...
categories = data %>% 
  select(speaker, opinion) %>% 
  rename(author = speaker,
         categories = opinion) %>% 
  mutate(author = paste0("agent_",author))

plot_speaker_landscapes(landscape,
                        tokens_to_plot = frequent_words,
                        alpha_points = .6, size_points = 1,
